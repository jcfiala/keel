...
function keel_menu_tree($variables) {
...
*/
function keel_menu_link(array $variables) {
...
function keel_views_mini_pager($vars) {
  global $pager_page_array, $pager_total;
...
function keel_item_list($variables) {
