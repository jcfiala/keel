...
*/
function keel_preprocess_views_view(&$vars){
...
function keel_preprocess_views_view_list(&$vars){
  //we need to go down to the unformatted preprocess to rip out the individual classes
  keel_preprocess_views_view_unformatted($vars);
}
...
*/
function keel_preprocess_views_view_unformatted(&$vars) {
  //renaming classes
