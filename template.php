<?php
/**
 * Template file for Keel basetheme.
 */
...
if (theme_get_setting('keel_rebuild_registry')) {
...
*/
function keel_preprocess(&$vars, $hook) {
  global $theme;
  global $base_url;
  $path = drupal_get_path('theme', $theme);
  $path_keel = drupal_get_path('theme', 'keel');
  ...
  */
  ...
  if ( $hook == "html" ) {
    ...
    $vars['keel_path'] = $base_url .'/'. $path_keel;
    ...
    */
    /*if (theme_get_setting('mothership_css_reset')) {
      drupal_add_css( $path_keel . '/css/reset.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -20));
    }
    if (theme_get_setting('mothership_css_reset_html5')) {
      drupal_add_css( $path_keel . '/css/reset-html5.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -20));
    }
    if (theme_get_setting('mothership_css_normalize')) {
      drupal_add_css( $path_keel . '/css/normalize.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -20));
    }
    if (theme_get_setting('mothership_css_default')) {
      drupal_add_css( $path_keel . '/css/mothership-default.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -15));
    }
    if (theme_get_setting('keel_css_layout')) {
      drupal_add_css( $path_keel . '/css/keel-layout.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -14));
    }
    if (theme_get_setting('mothership_css_mothershipstyles')) {
      drupal_add_css( $path_keel . '/css/keel.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => -10));
    }

    if (theme_get_setting('mothership_mediaquery_indicator')) {
      drupal_add_css( $path_keel . '/css/keel-devel-mediaqueries.css', array('group' => CSS_THEME, 'every_page' => TRUE, 'weight' => 0));
    }*/
    ...
    /*if (theme_get_setting('keel_modernizr')) {
...
function keel_process_html(&$vars, $hook) {
...
*/
function keel_process_html_tag(&$vars) {
  $el = &$vars['element'];
...
*/
function keel_class_killer(&$vars){
